...
public class FrameView extends JFrame implements View {
   ...
   */
  public FrameView(String caption, Model model) {
    super(caption);
  ...
  private class EchoButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      String text = FrameView.this.input.getText();
      // 2. Give text to model
      FrameView.this.model.setString(text);
      // 3. Read text from model
      String displayText = FrameView.this.model.getString();
      // 4. Set text to label
      FrameView.this.display.setText(displayText);
      // 5. Clear text field
      FrameView.this.input.setText("");
    }
  }
